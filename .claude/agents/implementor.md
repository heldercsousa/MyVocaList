...
1. `Docs/Management/[section-or-filing-dir]/[feature]/design.md` — spec for the feature you are implementing
2. `Docs/Management/[section-or-filing-dir]/[feature]/requirements.md` — acceptance criteria and validation rules
...
**Docs/ scope rule:** Read only `Docs/Management/[section-or-filing-dir]/[feature]/` and the explicit plan path from your briefing. Never glob-scan `Docs/`. `Docs/DevEnv/SDD/`, `Docs/Changelog/`, and `Docs/Plans/` are `.claudeignore`-excluded — access by explicit absolute path only if the briefing authorises it.
...
- [ ] `Docs/Management/[section-or-filing-dir]/[feature]/requirements.md` exists and has been read
- [ ] `Docs/Management/[section-or-filing-dir]/[feature]/design.md` exists and has been read
