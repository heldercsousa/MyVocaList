...
$folderMap = [ordered]@{
    ...
    'Docs\Management\BusinessFeatures\artists-songs\'    = '{C141C5C9-833C-4A26-96BF-3745A2DA1AD4}'
    'Docs\Management\DevCycleCraft\m3-lists\'         = '{F58ED7A0-0186-4187-9FCF-78A464FB01C5}'
    'Docs\Management\BusinessFeatures\persons\'          = '{D01D4F5A-EA21-4BEA-9808-B8FD795E79C7}'
    'Docs\Management\DevCycleCraft\styles-structure\' = '{1093A402-3B6A-487E-B4AD-76087EDAC809}'
    'Docs\Management\BusinessFeatures\venues\'           = '{9EA47D78-293E-41B7-872D-3B2B85E82710}'
    'Docs\Management\BusinessFeatures\artists-songs\youtube-karaoke\'  = '{6851C0F2-5877-4E2F-89C0-9B82A6770BE0}'
