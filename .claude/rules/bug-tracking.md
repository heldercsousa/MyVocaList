...
> **Authorship note:** This routing table must be human-reviewed before it is relied upon (CLAUDE.md § Continuous Enhancement — Authorship). Full content preserved in `library/bug-tracking-reference.md`.
