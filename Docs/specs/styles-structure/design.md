...
**Out of scope (moved to Step 3):** TDD foundation for existing CRUD — this belongs in a dedicated step after TDD guidelines are written (Step 2), not bundled here.
