...
|------|-------------|------|--------|-------|
| P2-A | Create `.claude/rules/constraints-registry.md` | OPP-4-9 | In Progress | |
...
| Step | Description | OPPs | Status | Notes |
|------|-------------|------|--------|-------|
| P8-01 | Add determinism rule for quality attributes | OPP-2-21 | Pending | |
...
| P9-16 | Update Context7 invocation discipline | OPP-7-7 | Pending | |
