...
| INLINE-AC | Song artist field — correctness fixes (BUG-050/051/052 + retain-text) + inline create-new-artist | IMPLEMENTATION COMPLETE (T1–T9); code review APPROVE-WITH-MINOR, M1–M4 folded in, M5 skipped; **517/517 green**; docs consolidated to develop | `feat/inline-artist-create` | `../MyVocaList-inline-ac` | to review (awaiting T10 on-device) | 50ad9eb | **Helder: (1) run T10 on-device** (DX-AC T7 checklist a,b,c,e,i,j + inline-create E2E: novel→➕→created+locked+saved; exact-existing→dup error, no orphan); **(2) push** `feat/inline-artist-create` (8 commits, not pushed — wincred); (3) on all-green close BUG-027/050/051/052, merge to develop, remove worktree, unblock Artists & Songs Catalog. |
