...
| INLINE-AC | Inline "create new artist" on the Song form | spec written + spec-reviewer PASS (2026-07-21); awaiting Helder spec review, then plan | — (docs on develop) | — | to review | a62db2f | Helder: review spec in `BusinessFeatures/artists-songs/changes/2026-07-21-inline-artist-create/`; on approval → writing-plans → plan-reviewer → implement (T1 DX capability spike first) in worktree |
