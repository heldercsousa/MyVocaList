...
| 2026-07-21 | ↳ **Song artist field — correctness fixes + inline "create new artist"** | 🟡 In Progress | Goal: make the Song Artist autocomplete correct (folding in BUG-050, BUG-051, BUG-052 and retain-text) and add inline create-new-artist (➕ row), closing BUG-027. Gate: on-device T10 failed 2026-07-22 — BUG-053 fixed, six defects remain (BUG-054 through BUG-059), rooted in the DX `AutoCompleteEdit` wiring rather than the ViewModel. Pointer: `BusinessFeatures/artists-songs/changes/2026-07-21-inline-artist-create/task-log.md`. |
