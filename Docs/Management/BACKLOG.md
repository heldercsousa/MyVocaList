...
| 2026-06 | ↳↳ Step 7a.1: Expand ICrudListViewModel for compiled bindings | ✅ Done | Review finding: CrudListView.xaml binds 14 members not on ICrudListViewModel — MAUI falls back to reflection. Add all bound members to the interface so CrudListView gets compiled bindings. Deferrable to Step 7e. |
