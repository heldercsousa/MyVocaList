...
| 2026-09-23 | ↳ Song form edit mode — clear (X) icon disabled on locked artist, artist cannot be replaced | 💡 Pending | Goal: Regression of REQ-ACREATE-15: in edit mode the locked Artist field renders its clear icon disabled, so the only unlock affordance is gone and a saved song's artist cannot be changed. Gate: Clear icon unlocks and clears the field in edit mode; VM-seam regression test Red then Green; Helder re-verifies on device. Pointer: `BusinessFeatures/artists-songs/bugs/2026-09-23-BUG-081-song-form-edit-mode-clear-x-icon-disabled-on-locked-artist-artist-cannot-be-replaced/`. |
