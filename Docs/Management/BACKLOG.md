...
| 2026-07-19 | ↳↳ **Replace `AutocompleteMobileField` consumers with DX `AutoCompleteEdit`** | 💡 Pending | Goal: mature built-in autocomplete on all form consumers; unblocks BUG-027 → Artists & Songs Catalog. Gate: spec required (brainstorming → spec-reviewer → Helder). Pointer: `DevCycleCraft/autocomplete-component/2026-07-19-dx-autocomplete-adoption-decision.md`. |
