...
| 2026-06 | **Search Page Component** | 🟡 In Progress | Replaces non-MD3 inline search strips with 3 picker pages. Phase 1 in progress. Spec: `Docs/Management/BusinessFeatures/search-page-component/` · Plan: `Docs/Management/BusinessFeatures/search-page-component/plan.md` · Tasks: `tasks.md` |
