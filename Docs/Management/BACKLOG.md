...
| 2026-07-19 | ↳↳ **Replace `AutocompleteMobileField` consumers with DX `AutoCompleteEdit`** | 📋 Spec | Goal: mature built-in autocomplete on all form consumers; unblocks BUG-027 → Artists & Songs Catalog. Gate: spec written 2026-07-19 (Approach A approved in brainstorming) — awaiting spec-reviewer + Helder gate. Pointer: `DevCycleCraft/autocomplete-component/changes/2026-07-19-dx-autocompleteedit-replacement/`. |
