...
| 2026-06 | **App Settings** | 🗺️ Plan | In-app settings page; initial required setting: YouTube Data API v3 key (enables YouTube search in SongFormPage — the page already renders a nudge pointing users here when the key is absent; `HasYouTubeApiKey` binding already wired) |
