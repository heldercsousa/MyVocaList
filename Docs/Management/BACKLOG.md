...
| 2026-06 | **Crash & Error Reporting** | 🗺️ Plan | Sentry MAUI SDK + Serilog sink; fixes orphaned Serilog config + uninitialized GlobalExceptionHandler. Spec: `Docs/Management/BusinessFeatures/crash-reporting/` · Plan: `Docs/Management/BusinessFeatures/crash-reporting/plan.md` |
