...
>
> - **[x] F4 (closed 2026-07-22 as NOT-A-DEFECT — premise stale) — `render._section_from_path` is NOT
>   dead code.** `walk()` builds `rel_path` as `Docs/Management/…`, so the function tests
