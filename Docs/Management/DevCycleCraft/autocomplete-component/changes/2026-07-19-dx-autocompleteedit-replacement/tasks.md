...
- [x] **T2 — MaterialStyles.xaml: AutoCompleteEdit form style** (REQ-DXAC-12)
...
- [x] **T3 — SongFormPage Artist field swap** (REQ-DXAC-01/03/04/05/06/07)
...
- [x] **T4 — PersonFormPage Full Name field swap** (REQ-DXAC-02/03/04/05/06/07)
