...
| 2026-06 | ↳ Bug: QueuePage BottomSheet double-add on navigation (BUG-011) | ✅ Fixed | Fixed via safe ConfirmSheet wrapper; caveat: fix branch `fix/bug-011-queue-bottomsheet` not merged and E2E blocked until the Queue Entry Point Redesign ships an entry point. Pointer: `BusinessFeatures/queue-management/bugs/BUG-011-queuepage-bottomsheet-double-add.md`. |
