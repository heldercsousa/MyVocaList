...
| 2026-06-27 | BUG-018: ArtistFormPage Edit Save — fatal EF Core duplicate-tracking crash (Critical) (under: **Artists & Songs Catalog**) | ✅ Fixed | Goal: Fixed (global NoTracking + read models); regression test green. Pointer: `BusinessFeatures/artists-songs/bugs/2026-06-27-BUG-018-artistformpage-edit-save-crash/`. |
...
| 2026-06-30 | BUG-019: ArtistsPage list item trailing button no-op + name invisible (Major) (under: **Artists & Songs Catalog**) | ✅ Fixed | Goal: Name visibility fix holds; the trailing-button regression is re-tracked as active BUG-028. Pointer: `BusinessFeatures/artists-songs/bugs/2026-06-30-BUG-019-artistspage-listitem-button-noop/`. |
