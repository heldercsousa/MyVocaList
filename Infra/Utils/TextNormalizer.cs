...
{
    /// <summary>
    /// Centralized utility for multilingual text normalization
    /// Supports the 11 languages of the application
    /// </summary>
    public class TextNormalizer : ITextNormalizer
    {
        // Accent mapping for normalization (without duplicates)
